...
![A vintage open textbook on a wooden desk showing audio waveforms, a vocal-tract diagram, and a spectrogram, with a yellow sticky note in the center reading "Chamgei" — a Kalenjin greeting](/blog/kalenjin-hero.png)
