    ...
    <div className="space-y-16">
      ...
      <section className="space-y-6">
        ...
        <p className="text-lg text-neutral-600 dark:text-neutral-400 max-w-2xl leading-relaxed">
          I build <span className="text-neutral-900 dark:text-neutral-100 font-medium">AI agents and automations</span> that help teams work smarter. Previously at CrewAI, Snowflake, Bloomberg. US Army veteran. Speaker at PyCon US, ODSC, Harvard, and more.
        </p>
        <div className="flex flex-wrap gap-4">
          <a
            ...
            className="inline-flex items-center gap-2 bg-neutral-900 dark:bg-neutral-100 text-white dark:text-neutral-900 px-4 py-2 rounded-md font-medium hover:bg-neutral-700 dark:hover:bg-neutral-300 transition-colors"
          >
            Get in Touch
          </a>
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 border border-neutral-300 dark:border-neutral-700 px-4 py-2 rounded-md font-medium hover:bg-neutral-100 dark:hover:bg-neutral-800 transition-colors"
          >
