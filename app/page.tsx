        ...
        <div className="flex flex-col items-center justify-center">
          <div className="flex flex-wrap gap-3 justify-center bg-neutral-100 dark:bg-neutral-800 rounded-xl px-4 py-2 shadow-sm mt-4">
            <Link
              ...
              className="inline-flex items-center p-1.5 rounded-lg bg-neutral-100 dark:bg-neutral-800 text-neutral-900 dark:text-neutral-100 hover:bg-neutral-200 dark:hover:bg-neutral-700 transition-colors"
