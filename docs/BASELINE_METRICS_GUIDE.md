...
|--------|-------|--------|----------------|
| **Total Monthly Visitors** | _____ | Plausible/Vercel | __________ |
| **Total Monthly Pageviews** | _____ | Plausible/Vercel | __________ |
| **Organic Search Traffic** | _____ | GSC or Analytics | __________ |
| **Direct Traffic** | _____ | Analytics | __________ |
| **Referral Traffic** | _____ | Analytics | __________ |
| **Social Traffic** | _____ | Analytics | __________ |
...
| Metric | Value | Source | Date Collected |
|--------|-------|--------|----------------|
| **Average Session Duration** | _____ | Analytics | __________ |
| **Bounce Rate** | _____ | Analytics | __________ |
| **Pages per Session** | _____ | Analytics | __________ |
| **Top 3 Pages** | 1. _____ 2. _____ 3. _____ | Analytics | __________ |
...
| Metric | Value | Source | Date Collected |
|--------|-------|--------|----------------|
| **Total Clicks (28 days)** | _____ | GSC | __________ |
| **Total Impressions (28 days)** | _____ | GSC | __________ |
| **Average CTR** | _____ | GSC | __________ |
| **Average Position** | _____ | GSC | __________ |
| **Keywords in Top 10** | _____ | GSC | __________ |
| **Keywords in Top 20** | _____ | GSC | __________ |
...
| Metric | Value | Source | Date Collected |
|--------|-------|--------|----------------|
| **Domain Authority (DA)** | _____ | Moz | __________ |
| **Domain Rating (DR)** | _____ | Ahrefs | __________ |
| **Total Backlinks** | _____ | Ahrefs/Moz | __________ |
| **Referring Domains** | _____ | Ahrefs/Moz | __________ |
...
|--------|-------|-------------|
| **Perplexity Citations** | 0 | __________ |
| **ChatGPT Citations** | 0 | __________ |
| **Google AI Overview Appearances** | 0 | __________ |
| **Claude Citations** (if available) | 0 | __________ |
| **Total AI Engine Citations** | 0 | __________ |
...
| Metric | Value | Source | Date Collected |
|--------|-------|--------|----------------|
| **Twitter Followers** | _____ | Twitter | __________ |
| **LinkedIn Connections** | _____ | LinkedIn | __________ |
| **YouTube Subscribers** | _____ | YouTube | __________ |
| **GitHub Stars (all repos)** | _____ | GitHub | __________ |
...
## Search
- Total Clicks (28d): _____
- Total Impressions (28d): _____
- Average CTR: _____
